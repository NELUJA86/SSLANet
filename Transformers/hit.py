...
if __name__ == '__main__':
    ...
    segment_dim = [8, 8, 4, 4]
    mlp_ratios = [3, 3, 3, 3]
    embed_dims = [512, 512, 256, 256]  ## for IN 368, for GRSS 256, for PU 168, for KSC 320 for XA 480
    model = HiT(layers, img_size=15, in_chans=256, num_classes=16, embed_dims=embed_dims, patch_size=3,
